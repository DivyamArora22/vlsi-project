...
#class/ece425/FreePDK45/osu_soc/lib/files/gscl45nm.lef
...
floorPlan -site CoreSite -s 110 80 10 10 10 10
...
for {set i 0} {$i < 32} {incr i} {
    placeInstance "cpu/datapath/bitslices[$i].bitslice/regfile" $x $y
    set y [expr {$y + 1.45}]
}


# TODO specify where are the pins
editPin -pin { clk rst imem_rdata[31:0] dmem_rdata[31:0] } \
  -side LEFT -spreadType CENTER -layer metal3

editPin -pin { imem_addr[31:0] dmem_addr[31:0] dmem_write dmem_wmask[3:0] dmem_wdata[31:0] } \
...
streamOut cpu2.gdsii -mapFile "/class/ece425/innovus.map"
